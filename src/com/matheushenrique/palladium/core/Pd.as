 ...
 */
    ...
    public class Pd
    {
        ...
        * @param sourceObject
        */ 
        public static function extend(targetObject:Object, sourceObject:Object):Object {
    	...
    	public static function has_key(targetObject:Object, key:String):Boolean {
	        try {
	            if (!targetObject[key]) return false; 
	        } catch(e:Error) {
	            return false;
	        }
    	...
    	public static function has_keys(targetObject:Object, keys:Array):Object {
	        
	        var i:uint = 0;
	        
	        for (var key:String in keys) {
	            try {
	                if (targetObject[key]) i++; 
	            } catch(e:Error) {
	                continue;
	            }
    	    }
            
            return {has:(i>0) ? true : false, amount:i};
        }
    }
}